...
public class Pending_Adapter extends ArrayAdapter {
    ...
    class Datahandler {
        ...
        TextView txt_productName,txt_desc,txt_price,txt_count,txt_initial;
        TextView header;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            ...
            switch (rowType) {
                ...
                case TYPE_ITEM :
                    ...
                    handler.txt_productName = (TextView)row.findViewById(R.id.txt_store_name);
        ...
        switch (rowType) {
            ...
            handler.txt_count.setText(""+pending_model.getQuantity());
