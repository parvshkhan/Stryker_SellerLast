...
import com.quickblox.sample.chat.SellerApplicationSingleton_Seller;
...
public class PlayServicesHelper {
    ...
    private String getRegistrationId() {
        ...
        int currentVersion = SellerApplicationSingleton_Seller.getInstance().getAppVersion();
    ...
    private void storeRegistrationId(String regId) {
        final SharedPreferences prefs = getGCMPreferences();
        int appVersion = SellerApplicationSingleton_Seller.getInstance().getAppVersion();
